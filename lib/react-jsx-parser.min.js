...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,s,i){return s&&t(e.prototype,s),i&&t(e,i),e}}(),c=s(1),u=s(5),l=i(u),d=s(6),f=i(d),m=s(8),x=i(m),y=s(9),v={plugins:{jsx:!0,allowNamespacedObjects:true}},b=function(t){function e(t){r(this,e)
var s=n(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t))
return g.call(s),s.handleNewProps(t),s}return a(e,t),p(e,[{key:"componentWillReceiveProps",value:function(t){this.handleNewProps(t)}}]),e}(u.Component),g=function(){var t=this
...
try{i=new c.Parser(v,s).parse(),i=i.body[0].expression.children||[]}catch(e){return t.props.showWarnings&&console.warn(e),t.props.onError&&t.props.onError(e),[]}return i.map(t.parseExpression).filter(Boolean)},this.parseExpression=function(e,s){switch(e.type){case"JSXElement":return t.parseElement(e,s)
case"JSXText":return e.value||""
...
case"ObjectExpression":var i={}
return e.properties.forEach(function(e){i[e.key.name]=t.parseExpression(e.value)}),i
case"JSXExpressionContainer":return t.parseExpression(e.expression)
case"Literal":return e.value
default:return}},this.parseElement=function(e,s){var i=t.props,r=i.bindings,n=void 0===r?{}:r,a=i.components,p=void 0===a?{}:a,c=e.children,u=void 0===c?[]:c,d=e.openingElement,m=d.attributes,v=d.name.name
if(/^(html|head|body)$/i.test(v))return u.map(function(e){return t.parseElement(e)})
if(-1===t.blacklistedTags.indexOf(v.trim().toLowerCase())){var b=void 0
if(p[v]||(0,y.canHaveChildren)(v))if(b=u.map(t.parseExpression),p[v]||(0,y.canHaveWhitespace)(v)||(b=b.filter(function(t){return"string"!=typeof t||!/^\s*$/.test(t)})),0===b.length)b=void 0
else if(1===b.length){var g=b,k=h(g,1)
b=k[0]}var E=o({key:s},n)
return m.forEach(function(e){var s=e.name.name,i=x.default[s]||s,r=t.parseExpression(e)
0===t.blacklistedAttrs.filter(function(t){return t.test(i)}).length&&(E[i]=r)}),"string"==typeof E.style&&(E.style=(0,f.default)(E.style)),l.default.createElement(p[v]||v,E,b)}},this.render=function(){return t.props.renderInWrapper?l.default.createElement("div",{className:"jsx-parser"},t.ParsedChildren):t.ParsedChildren}}
...
if(false||!this.eat(s.colon))return i
...
for(this.type!==s.dot||"JSXNamespacedName"!==i.type||true||this.unexpected();this.eat(s.dot);){var r=this.startNodeAt(t,e)
...
return this.next(),this.jsx_parseElementAt(t,e)},t.plugins.jsx=function(e,i){i&&("object"!=typeof i&&(i={}),e.options.plugins.jsx={allowNamespaces:true,allowNamespacedObjects:true},e.extend("parseExprAtom",function(t){return function(e){return this.type===s.jsxText?this.jsx_parseText(this.value):this.type===s.jsxTagStart?this.jsx_parseElement():t.call(this,e)}}),e.extend("readToken",function(e){return function(i){var r=this.curContext()
...
function e(t,e){for(var s=65536,i=0;i<e.length;i+=2){if((s+=e[i])>t)return!1
...
var r=R.exec(t)
if(!(r&&r.index<e))return new q(s,e-i);++s,i=r.index+r[0].length}}function p(t){var e={}
for(var s in z)e[s]=t&&o(t,s)?t[s]:z[s]
if(e.ecmaVersion>=2015&&(e.ecmaVersion-=2009),null==e.allowReserved&&(e.allowReserved=e.ecmaVersion<5),B(e.onToken)){var i=e.onToken
...
t.locations&&(h.loc=new X(this,a,o)),t.ranges&&(h.range=[r,n]),e.push(h)}}function u(t){return new RegExp("^("+t.replace(/ /g,"|")+")$")}function l(t,e,s,i){return t.type=e,t.end=s,this.options.locations&&(t.loc.end=i),this.options.ranges&&(t.range[1]=s),t}function d(t,e,s,i){try{return new RegExp(t,e)}catch(t){if(void 0!==s)throw t instanceof SyntaxError&&i.raise(s,"Error parsing regular expression: "+t.message),t}}function f(t){return t<=65535?String.fromCharCode(t):(t-=65536,String.fromCharCode(55296+(t>>10),56320+(1023&t)))}function m(t,e){return new J(e,t).parse()}function x(t,e,s){var i=new J(s,t,e)
return i.nextToken(),i.parseExpression()}function y(t,e){return new J(e,t)}function v(e,s,i){t.parse_dammit=e,t.LooseParser=s,t.pluginsLoose=i}var b={3:"abstract boolean byte char class double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile",5:"class enum extends super const export import",6:"enum",strict:"implements interface let package private protected public static yield",strictBind:"eval arguments"},g="break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this",k={5:g,6:g+" const class extends export import super"},E="ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙա-ևא-תװ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࢠ-ࢴࢶ-ࢽऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೞೠೡೱೲഅ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄງຈຊຍດ-ທນ-ຟມ-ຣລວສຫອ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜌᜎ-ᜑᜠ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡷᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭋᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲈᳩ-ᳬᳮ-ᳱᳵᳶᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-Ⱞⰰ-ⱞⱠ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄭㄱ-ㆎㆠ-ㆺㇰ-ㇿ㐀-䶵一-鿕ꀀ-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꞮꞰ-ꞷꟷ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭥꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ",w="‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࣔ-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ଁ-ଃ଼ା-ୄେୈୋ-୍ୖୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఃా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ഁ-ഃാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ංඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ູົຼ່-ໍ໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜔ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠐-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭ᳲ-᳴᳸᳹᷀-᷵᷻-᷿‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱꤀-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿",A=new RegExp("["+E+"]"),S=new RegExp("["+E+w+"]")
E=w=null
...
var X=function(t,e,s){this.start=e,this.end=s,null!==t.sourceFile&&(this.source=t.sourceFile)},z={ecmaVersion:7,sourceType:"script",onInsertedSemicolon:null,onTrailingComma:null,allowReserved:null,allowReturnOutsideFunction:!1,allowImportExportEverywhere:!1,allowHashBang:!1,locations:!1,onToken:null,onComment:null,ranges:!1,program:null,sourceFile:null,directSourceFile:null,preserveParens:!1,plugins:{}},W={},J=function(t,e,s){this.options=t=p(t),this.sourceFile=t.sourceFile,this.keywords=u(k[t.ecmaVersion>=6?6:5])
var i=""
if(!t.allowReserved){for(var r=t.ecmaVersion;!(i=b[r]);r--);"module"==t.sourceType&&(i+=" await")}this.reservedWords=u(i)
var n=(i?i+" ":"")+b.strict
this.reservedWordsStrict=u(n),this.reservedWordsStrictBind=u(n+" "+b.strictBind),this.input=String(e),this.containsEsc=!1,this.loadPlugins(t.plugins),s?(this.pos=s,this.lineStart=this.input.lastIndexOf("\n",s-1)+1,this.curLine=this.input.slice(0,this.lineStart).split(I).length):(this.pos=this.lineStart=0,this.curLine=1),this.type=j.eof,this.value=null,this.start=this.end=this.pos,this.startLoc=this.endLoc=this.curPosition(),this.lastTokEndLoc=this.lastTokStartLoc=null,this.lastTokStart=this.lastTokEnd=this.pos,this.context=this.initialContext(),this.exprAllowed=!0,this.inModule="module"===t.sourceType,this.strict=this.inModule||this.strictDirective(this.pos),this.potentialArrowAt=-1,this.inFunction=this.inGenerator=this.inAsync=!1,this.yieldPos=this.awaitPos=0,this.labels=[],0===this.pos&&t.allowHashBang&&"#!"===this.input.slice(0,2)&&this.skipLineComment(2),this.scopeStack=[],this.enterFunctionScope()}
J.prototype.isKeyword=function(t){return this.keywords.test(t)},J.prototype.isReservedWord=function(t){return this.reservedWords.test(t)},J.prototype.extend=function(t,e){this[t]=e(this[t])},J.prototype.loadPlugins=function(t){var e=this
for(var s in t){var i=W[s]
if(!i)throw new Error("Plugin '"+s+"' not found")
i(e,t[s])}},J.prototype.parse=function(){var t=this.options.program||this.startNode()
...
if(t.label&&i)break}}return r===this.labels.length&&this.raise(t.start,"Unsyntactic "+e),this.finishNode(t,i?"BreakStatement":"ContinueStatement")},H.parseDebuggerStatement=function(t){return this.next(),this.semicolon(),this.finishNode(t,"DebuggerStatement")},H.parseDoStatement=function(t){return this.next(),this.labels.push(Y),t.body=this.parseStatement(!1),this.labels.pop(),this.expect(j._while),t.test=this.parseParenExpression(),this.options.ecmaVersion>=6?this.eat(j.semi):this.semicolon(),this.finishNode(t,"DoWhileStatement")},H.parseForStatement=function(t){if(this.next(),this.labels.push(Y),this.enterLexicalScope(),this.expect(j.parenL),this.type===j.semi)return this.parseFor(t,null)
var e=this.isLet()
...
else{for(var a=0;a<t.specifiers.length;a++)(s.keywords.test(t.specifiers[a].local.name)||s.reservedWords.test(t.specifiers[a].local.name))&&s.unexpected(t.specifiers[a].local.start)
t.source=null}this.semicolon()}return this.finishNode(t,"ExportNamedDeclaration")},H.checkExport=function(t,e,s){t&&(o(t,e)&&this.raiseRecoverable(s,"Duplicate export '"+e+"'"),t[e]=!0)},H.checkPatternExport=function(t,e){var s=this,i=e.type
if("Identifier"==i)this.checkExport(t,e.name,e.start)
else if("ObjectPattern"==i)for(var r=0;r<e.properties.length;++r)s.checkPatternExport(t,e.properties[r].value)
else if("ArrayPattern"==i)for(var n=0;n<e.elements.length;++n){var a=e.elements[n]
a&&s.checkPatternExport(t,a)}else"AssignmentPattern"==i?this.checkPatternExport(t,e.left):"ParenthesizedExpression"==i&&this.checkPatternExport(t,e.expression)},H.checkVariableExport=function(t,e){var s=this
if(t)for(var i=0;i<e.length;i++)s.checkPatternExport(t,e[i].id)},H.shouldParseExportStatement=function(){return"var"===this.type.keyword||"const"===this.type.keyword||"class"===this.type.keyword||"function"===this.type.keyword||this.isLet()||this.isAsyncFunction()},H.parseExportSpecifiers=function(t){var e=this,s=[],i=!0
for(this.expect(j.braceL);!this.eat(j.braceR);){if(i)i=!1
else if(e.expect(j.comma),e.afterTrailingComma(j.braceR))break
var r=e.startNode()
r.local=e.parseIdent(!0),r.exported=e.eatContextual("as")?e.parseIdent(!0):r.local,e.checkExport(t,r.exported.name,r.exported.start),s.push(e.finishNode(r,"ExportSpecifier"))}return s},H.parseImport=function(t){return this.next(),this.type===j.string?(t.specifiers=Z,t.source=this.parseExprAtom()):(t.specifiers=this.parseImportSpecifiers(),this.expectContextual("from"),t.source=this.type===j.string?this.parseExprAtom():this.unexpected()),this.semicolon(),this.finishNode(t,"ImportDeclaration")},H.parseImportSpecifiers=function(){var t=this,e=[],s=!0
if(this.type===j.name){var i=this.startNode()
if(i.local=this.parseIdent(),this.checkLVal(i.local,"let"),e.push(this.finishNode(i,"ImportDefaultSpecifier")),!this.eat(j.comma))return e}if(this.type===j.star){var r=this.startNode()
return this.next(),this.expectContextual("as"),r.local=this.parseIdent(),this.checkLVal(r.local,"let"),e.push(this.finishNode(r,"ImportNamespaceSpecifier")),e}for(this.expect(j.braceL);!this.eat(j.braceR);){if(s)s=!1
else if(t.expect(j.comma),t.afterTrailingComma(j.braceR))break
var n=t.startNode()
n.imported=t.parseIdent(!0),t.eatContextual("as")?n.local=t.parseIdent():(n.local=n.imported,t.isKeyword(n.local.name)&&t.unexpected(n.local.start),t.reservedWordsStrict.test(n.local.name)&&t.raiseRecoverable(n.local.start,"The keyword '"+n.local.name+"' is reserved")),t.checkLVal(n.local,"let"),e.push(t.finishNode(n,"ImportSpecifier"))}return e}
var K=J.prototype
K.toAssignable=function(t,e){var s=this
...
for(var i=0;i<t.properties.length;i++){var r=t.properties[i]
"init"!==r.kind&&s.raise(r.key.start,"Object pattern can't contain getter or setter"),s.toAssignable(r.value,e)}break
case"ArrayExpression":t.type="ArrayPattern",this.toAssignableList(t.elements,e)
break
case"AssignmentExpression":if("="!==t.operator){this.raise(t.left.end,"Only '=' operator can be used for specifying default value.")
break}t.type="AssignmentPattern",delete t.operator,this.toAssignable(t.left,e)
case"AssignmentPattern":break
case"ParenthesizedExpression":t.expression=this.toAssignable(t.expression,e)
break
case"MemberExpression":if(!e)break
default:this.raise(t.start,"Assigning to rvalue")}return t},K.toAssignableList=function(t,e){var s=this,i=t.length
if(i){var r=t[i-1]
if(r&&"RestElement"==r.type)--i
else if(r&&"SpreadElement"==r.type){r.type="RestElement"
var n=r.argument
this.toAssignable(n,e),"Identifier"!==n.type&&"MemberExpression"!==n.type&&"ArrayPattern"!==n.type&&this.unexpected(n.start),--i}e&&r&&"RestElement"===r.type&&"Identifier"!==r.argument.type&&this.unexpected(r.argument.start)}for(var a=0;a<i;a++){var o=t[a]
o&&s.toAssignable(o,e)}return t},K.parseSpread=function(t){var e=this.startNode()
return this.next(),e.argument=this.parseMaybeAssign(!1,t),this.finishNode(e,"SpreadElement")},K.parseRest=function(t){var e=this.startNode()
return this.next(),e.argument=t?this.type===j.name?this.parseIdent():this.unexpected():this.type===j.name||this.type===j.bracketL?this.parseBindingAtom():this.unexpected(),this.finishNode(e,"RestElement")},K.parseBindingAtom=function(){if(this.options.ecmaVersion<6)return this.parseIdent()
switch(this.type){case j.name:return this.parseIdent()
case j.bracketL:var t=this.startNode()
return this.next(),t.elements=this.parseBindingList(j.bracketR,!0,!0),this.finishNode(t,"ArrayPattern")
case j.braceL:return this.parseObj(!0)
default:this.unexpected()}},K.parseBindingList=function(t,e,s,i){for(var r=this,n=[],a=!0;!this.eat(t);)if(a?a=!1:r.expect(j.comma),e&&r.type===j.comma)n.push(null)
else{if(s&&r.afterTrailingComma(t))break
if(r.type===j.ellipsis){var o=r.parseRest(i)
r.parseBindingListItem(o),n.push(o),r.type===j.comma&&r.raise(r.start,"Comma is not permitted after the rest element"),r.expect(t)
break}var h=r.parseMaybeDefault(r.start,r.startLoc)
r.parseBindingListItem(h),n.push(h)}return n},K.parseBindingListItem=function(t){return t},K.parseMaybeDefault=function(t,e,s){if(s=s||this.parseBindingAtom(),this.options.ecmaVersion<6||!this.eat(j.eq))return s
...
break
case"ObjectPattern":for(var r=0;r<t.properties.length;r++)i.checkLVal(t.properties[r].value,e,s)
break
case"ArrayPattern":for(var n=0;n<t.elements.length;n++){var a=t.elements[n]
a&&i.checkLVal(a,e,s)}break
...
var tt=J.prototype
tt.checkPropClash=function(t,e){if(!(this.options.ecmaVersion>=6&&(t.computed||t.method||t.shorthand))){var s,i=t.key
switch(i.type){case"Identifier":s=i.name
break
case"Literal":s=String(i.value)
break
default:return}var r=t.kind
if(this.options.ecmaVersion>=6)return void("__proto__"===s&&"init"===r&&(e.proto&&this.raiseRecoverable(i.start,"Redefinition of __proto__ property"),e.proto=!0))
s="$"+s
var n=e[s]
if(n){var a
...
return this.parseExprOp(u,e,s,i,r)}return t},tt.buildBinary=function(t,e,s,i,r,n){var a=this.startNodeAt(t,e)
...
var u=n.parseExprList(j.parenR,n.options.ecmaVersion>=8,!1,h)
if(a&&!n.canInsertSemicolon()&&n.eat(j.arrow))return n.checkPatternErrors(h,!1),n.checkYieldAwaitInDefaultParams(),n.yieldPos=p,n.awaitPos=c,n.parseArrowExpression(n.startNodeAt(e,s),u,!0)
n.checkExpressionErrors(h,!0),n.yieldPos=p||n.yieldPos,n.awaitPos=c||n.awaitPos
var l=n.startNodeAt(e,s)
l.callee=t,l.arguments=u,t=n.finishNode(l,"CallExpression")}else{if(n.type!==j.backQuote)return t
...
var a,o,h=this.start,p=this.startLoc,c=[],u=!0,l=!1,d=new $,f=this.yieldPos,m=this.awaitPos
for(this.yieldPos=0,this.awaitPos=0;this.type!==j.parenR;){if(u?u=!1:s.expect(j.comma),n&&s.afterTrailingComma(j.parenR,!0)){l=!0
...
c.length&&!l||this.unexpected(this.lastTokStart),a&&this.unexpected(a),this.checkExpressionErrors(d,!0),this.yieldPos=f||this.yieldPos,this.awaitPos=m||this.awaitPos,c.length>1?(e=this.startNodeAt(h,p),e.expressions=c,this.finishNodeAt(e,"SequenceExpression",x,y)):e=c[0]}else e=this.parseParenExpression()
...
var a=this.labels
this.labels=[],r&&(this.strict=!0),this.checkParams(t,!i&&!r&&!e&&this.isSimpleParamList(t.params)),t.body=this.parseBlock(!1),t.expression=!1,this.labels=a}this.exitFunctionScope(),this.strict&&t.id&&this.checkLVal(t.id,"none"),this.strict=i},tt.isSimpleParamList=function(t){for(var e=0;e<t.length;e++)if("Identifier"!==t[e].type)return!1
return!0},tt.checkParams=function(t,e){for(var s=this,i={},r=0;r<t.params.length;r++)s.checkLVal(t.params[r],"var",e?null:i)},tt.parseExprList=function(t,e,s,i){for(var r=this,n=[],a=!0;!this.eat(t);){if(a)a=!1
else if(r.expect(j.comma),e&&r.afterTrailingComma(t))break
var o
s&&r.type===j.comma?o=null:r.type===j.ellipsis?(o=r.parseSpread(i),i&&r.type===j.comma&&i.trailingComma<0&&(i.trailingComma=r.start)):o=r.parseMaybeAssign(!1,i),n.push(o)}return n},tt.parseIdent=function(t){var e=this.startNode()
return t&&"never"==this.options.allowReserved&&(t=!1),this.type===j.name?(!t&&(this.strict?this.reservedWordsStrict:this.reservedWords).test(this.value)&&(this.options.ecmaVersion>=6||-1==this.input.slice(this.start,this.end).indexOf("\\"))&&this.raiseRecoverable(this.start,"The keyword '"+this.value+"' is reserved"),this.inGenerator&&"yield"===this.value&&this.raiseRecoverable(this.start,"Can not use 'yield' as identifier inside a generator"),this.inAsync&&"await"===this.value&&this.raiseRecoverable(this.start,"Can not use 'await' as identifier inside an async function"),e.name=this.value):t&&this.type.keyword?e.name=this.type.keyword:this.unexpected(),this.next(),this.finishNode(e,"Identifier")},tt.parseYield=function(){this.yieldPos||(this.yieldPos=this.start)
var t=this.startNode()
return this.next(),this.type==j.semi||this.canInsertSemicolon()||this.type!=j.star&&!this.type.startsExpr?(t.delegate=!1,t.argument=null):(t.delegate=this.eat(j.star),t.argument=this.parseMaybeAssign()),this.finishNode(t,"YieldExpression")},tt.parseAwait=function(){this.awaitPos||(this.awaitPos=this.start)
var t=this.startNode()
return this.next(),t.argument=this.parseMaybeUnary(null,!0),this.finishNode(t,"AwaitExpression")}
var st=J.prototype
st.raise=function(t,e){var s=h(this.input,t)
e+=" ("+s.line+":"+s.column+")"
var i=new SyntaxError(e)
throw i.pos=t,i.loc=s,i.raisedAt=this.pos,i},st.raiseRecoverable=st.raise,st.curPosition=function(){if(this.options.locations)return new q(this.curLine,this.pos-this.lineStart)}
var it=J.prototype,rt=Object.assign||function(t){for(var e=[],s=arguments.length-1;s-- >0;)e[s]=arguments[s+1]
for(var i=0;i<e.length;i++){var r=e[i]
for(var n in r)o(r,n)&&(t[n]=r[n])}return t}
it.enterFunctionScope=function(){this.scopeStack.push({var:{},lexical:{},childVar:{},parentLexical:{}})},it.exitFunctionScope=function(){this.scopeStack.pop()},it.enterLexicalScope=function(){var t=this.scopeStack[this.scopeStack.length-1],e={var:{},lexical:{},childVar:{},parentLexical:{}}
this.scopeStack.push(e),rt(e.parentLexical,t.lexical,t.parentLexical)},it.exitLexicalScope=function(){var t=this.scopeStack.pop(),e=this.scopeStack[this.scopeStack.length-1]
rt(e.childVar,t.var,t.childVar)},it.canDeclareVarName=function(t){var e=this.scopeStack[this.scopeStack.length-1]
return!o(e.lexical,t)&&!o(e.parentLexical,t)},it.canDeclareLexicalName=function(t){var e=this.scopeStack[this.scopeStack.length-1]
return!o(e.lexical,t)&&!o(e.var,t)&&!o(e.childVar,t)},it.declareVarName=function(t){this.scopeStack[this.scopeStack.length-1].var[t]=!0},it.declareLexicalName=function(t){this.scopeStack[this.scopeStack.length-1].lexical[t]=!0}
var nt=function(t,e,s){this.type="",this.start=e,this.end=0,t.options.locations&&(this.loc=new X(t,s)),t.options.directSourceFile&&(this.sourceFile=t.options.directSourceFile),t.options.ranges&&(this.range=[e,0])},at=J.prototype
at.startNode=function(){return new nt(this,this.start,this.startLoc)},at.startNodeAt=function(t,e){return new nt(this,t,e)},at.finishNode=function(t,e){return l.call(this,t,e,this.lastTokEnd,this.lastTokEndLoc)},at.finishNodeAt=function(t,e,s,i){return l.call(this,t,e,s,i)}
var ot=function(t,e,s,i,r){this.token=t,this.isExpr=!!e,this.preserveSpace=!!s,this.override=i,this.generator=!!r},ht={b_stat:new ot("{",!1),b_expr:new ot("{",!0),b_tmpl:new ot("${",!0),p_stat:new ot("(",!1),p_expr:new ot("(",!0),q_tmpl:new ot("`",!0,!0,function(t){return t.readTmplToken()}),f_expr:new ot("function",!0),f_expr_gen:new ot("function",!0,!1,null,!0),f_gen:new ot("function",!1,!1,null,!0)},pt=J.prototype
pt.initialContext=function(){return[ht.b_stat]},pt.braceIsBlock=function(t){if(t===j.colon){var e=this.curContext()
if(e===ht.b_stat||e===ht.b_expr)return!e.isExpr}return t===j._return?I.test(this.input.slice(this.lastTokEnd,this.start)):t===j._else||t===j.semi||t===j.eof||t===j.parenR||t==j.arrow||(t==j.braceL?this.curContext()===ht.b_stat:!this.exprAllowed)},pt.inGeneratorContext=function(){for(var t=this,e=this.context.length-1;e>=0;e--)if(t.context[e].generator)return!0
...
var ct=function(t){this.type=t.type,this.value=t.value,this.start=t.start,this.end=t.end,t.options.locations&&(this.loc=new X(t,t.startLoc,t.endLoc)),t.options.ranges&&(this.range=[t.start,t.end])},ut=J.prototype,lt="object"==typeof Packages&&"[object JavaPackage]"==Object.prototype.toString.call(Packages)
ut.next=function(){this.options.onToken&&this.options.onToken(new ct(this)),this.lastTokEnd=this.end,this.lastTokStart=this.start,this.lastTokEndLoc=this.endLoc,this.lastTokStartLoc=this.startLoc,this.nextToken()},ut.getToken=function(){return this.next(),new ct(this)},"undefined"!=typeof Symbol&&(ut[Symbol.iterator]=function(){var t=this
return{next:function(){var e=t.getToken()
return{done:e.type===j.eof,value:e}}}}),ut.curContext=function(){return this.context[this.context.length-1]},ut.nextToken=function(){var t=this.curContext()
return t&&t.preserveSpace||this.skipSpace(),this.start=this.pos,this.options.locations&&(this.startLoc=this.curPosition()),this.pos>=this.input.length?this.finishToken(j.eof):t.override?t.override(this):void this.readToken(this.fullCharCodeAtPos())},ut.readToken=function(t){return s(t,this.options.ecmaVersion>=6)||92===t?this.readWord():this.getTokenFromCode(t)},ut.fullCharCodeAtPos=function(){var t=this.input.charCodeAt(this.pos)
return t<=55295||t>=57344?t:(t<<10)+this.input.charCodeAt(this.pos+1)-56613888},ut.skipBlockComment=function(){var t=this,e=this.options.onComment&&this.curPosition(),s=this.pos,i=this.input.indexOf("*/",this.pos+=2)
if(-1===i&&this.raise(this.pos-2,"Unterminated comment"),this.pos=i+2,this.options.locations){R.lastIndex=s
for(var r;(r=R.exec(this.input))&&r.index<this.pos;)++t.curLine,t.lineStart=r.index+r[0].length}this.options.onComment&&this.options.onComment(!0,this.input.slice(s+2,i),s,this.pos,e,this.curPosition())},ut.skipLineComment=function(t){for(var e=this,s=this.pos,i=this.options.onComment&&this.curPosition(),r=this.input.charCodeAt(this.pos+=t);this.pos<this.input.length&&10!==r&&13!==r&&8232!==r&&8233!==r;)++e.pos,r=e.input.charCodeAt(e.pos)
this.options.onComment&&this.options.onComment(!1,this.input.slice(s+t,this.pos),s,this.pos,i,this.curPosition())},ut.skipSpace=function(){var t=this
...
default:if(!(e>8&&e<14||e>=5760&&O.test(String.fromCharCode(e))))break t;++t.pos}}},ut.finishToken=function(t,e){this.end=this.pos,this.options.locations&&(this.endLoc=this.curPosition())
var s=this.type
this.type=t,this.value=e,this.updateContext(s)},ut.readToken_dot=function(){var t=this.input.charCodeAt(this.pos+1)
if(t>=48&&t<=57)return this.readNumber(!0)
var e=this.input.charCodeAt(this.pos+2)
return this.options.ecmaVersion>=6&&46===t&&46===e?(this.pos+=3,this.finishToken(j.ellipsis)):(++this.pos,this.finishToken(j.dot))},ut.readToken_slash=function(){var t=this.input.charCodeAt(this.pos+1)
return this.exprAllowed?(++this.pos,this.readRegexp()):61===t?this.finishOp(j.assign,2):this.finishOp(j.slash,1)},ut.readToken_mult_modulo_exp=function(t){var e=this.input.charCodeAt(this.pos+1),s=1,i=42===t?j.star:j.modulo
return this.options.ecmaVersion>=7&&42===e&&(++s,i=j.starstar,e=this.input.charCodeAt(this.pos+2)),61===e?this.finishOp(j.assign,s+1):this.finishOp(i,s)},ut.readToken_pipe_amp=function(t){var e=this.input.charCodeAt(this.pos+1)
return e===t?this.finishOp(124===t?j.logicalOR:j.logicalAND,2):61===e?this.finishOp(j.assign,2):this.finishOp(124===t?j.bitwiseOR:j.bitwiseAND,1)},ut.readToken_caret=function(){return 61===this.input.charCodeAt(this.pos+1)?this.finishOp(j.assign,2):this.finishOp(j.bitwiseXOR,1)},ut.readToken_plus_min=function(t){var e=this.input.charCodeAt(this.pos+1)
return e===t?45==e&&62==this.input.charCodeAt(this.pos+2)&&I.test(this.input.slice(this.lastTokEnd,this.pos))?(this.skipLineComment(3),this.skipSpace(),this.nextToken()):this.finishOp(j.incDec,2):61===e?this.finishOp(j.assign,2):this.finishOp(j.plusMin,1)},ut.readToken_lt_gt=function(t){var e=this.input.charCodeAt(this.pos+1),s=1
return e===t?(s=62===t&&62===this.input.charCodeAt(this.pos+2)?3:2,61===this.input.charCodeAt(this.pos+s)?this.finishOp(j.assign,s+1):this.finishOp(j.bitShift,s)):33==e&&60==t&&45==this.input.charCodeAt(this.pos+2)&&45==this.input.charCodeAt(this.pos+3)?(this.inModule&&this.unexpected(),this.skipLineComment(4),this.skipSpace(),this.nextToken()):(61===e&&(s=2),this.finishOp(j.relational,s))},ut.readToken_eq_excl=function(t){var e=this.input.charCodeAt(this.pos+1)
return 61===e?this.finishOp(j.equality,61===this.input.charCodeAt(this.pos+2)?3:2):61===t&&62===e&&this.options.ecmaVersion>=6?(this.pos+=2,this.finishToken(j.arrow)):this.finishOp(61===t?j.eq:j.prefix,1)},ut.getTokenFromCode=function(t){switch(t){case 46:return this.readToken_dot()
...
case 126:return this.finishOp(j.prefix,1)}this.raise(this.pos,"Unexpected character '"+f(t)+"'")},ut.finishOp=function(t,e){var s=this.input.slice(this.pos,this.pos+e)
return this.pos+=e,this.finishToken(t,s)}
var dt=!!d("￿","u")
ut.readRegexp=function(){for(var t,e,s=this,i=this.pos;;){s.pos>=s.input.length&&s.raise(i,"Unterminated regular expression")
...
return lt||(d(o,h,i,this),c=d(n,a)),this.finishToken(j.regexp,{pattern:n,flags:a,value:c})},ut.readInt=function(t,e){for(var s=this,i=this.pos,r=0,n=0,a=null==e?1/0:e;n<a;++n){var o,h=s.input.charCodeAt(s.pos)
if((o=h>=97?h-97+10:h>=65?h-65+10:h>=48&&h<=57?h-48:1/0)>=t)break;++s.pos,r=r*t+o}return this.pos===i||null!=e&&this.pos-i!==e?null:r},ut.readRadixNumber=function(t){this.pos+=2
var e=this.readInt(t)
return null==e&&this.raise(this.start+2,"Expected number in radix "+t),s(this.fullCharCodeAtPos())&&this.raise(this.pos,"Identifier directly after number"),this.finishToken(j.num,e)},ut.readNumber=function(t){var e=this.pos,i=!1,r=48===this.input.charCodeAt(this.pos)
...
return i?a=parseFloat(o):r&&1!==o.length?/[89]/.test(o)||this.strict?this.raise(e,"Invalid number"):a=parseInt(o,8):a=parseInt(o,10),this.finishToken(j.num,a)},ut.readCodePoint=function(){var t,e=this.input.charCodeAt(this.pos)
...
return t},ut.readString=function(t){for(var e=this,s="",i=++this.pos;;){e.pos>=e.input.length&&e.raise(e.start,"Unterminated string constant")
var r=e.input.charCodeAt(e.pos)
if(r===t)break
92===r?(s+=e.input.slice(i,e.pos),s+=e.readEscapedChar(!1),i=e.pos):(a(r)&&e.raise(e.start,"Unterminated string constant"),++e.pos)}return s+=this.input.slice(i,this.pos++),this.finishToken(j.string,s)},ut.readTmplToken=function(){for(var t=this,e="",s=this.pos;;){t.pos>=t.input.length&&t.raise(t.start,"Unterminated template")
...
case 10:e+="\n"
break
default:e+=String.fromCharCode(i)}t.options.locations&&(++t.curLine,t.lineStart=t.pos),s=t.pos}else++t.pos}},ut.readEscapedChar=function(t){var e=this.input.charCodeAt(++this.pos)
switch(++this.pos,e){case 110:return"\n"
case 114:return"\r"
case 120:return String.fromCharCode(this.readHexChar(2))
case 117:return f(this.readCodePoint())
case 116:return"\t"
case 98:return"\b"
case 118:return"\v"
case 102:return"\f"
...
return i>255&&(s=s.slice(0,-1),i=parseInt(s,8)),"0"!==s&&(this.strict||t)&&this.raise(this.pos-2,"Octal literal in strict mode"),this.pos+=s.length-1,String.fromCharCode(i)}return String.fromCharCode(e)}},ut.readHexChar=function(t){var e=this.pos,s=this.readInt(16,t)
return null===s&&this.raise(e,"Bad character escape sequence"),s},ut.readWord1=function(){var t=this
this.containsEsc=!1
for(var e="",r=!0,n=this.pos,a=this.options.ecmaVersion>=6;this.pos<this.input.length;){var o=t.fullCharCodeAtPos()
if(i(o,a))t.pos+=o<=65535?1:2
else{if(92!==o)break
t.containsEsc=!0,e+=t.input.slice(n,t.pos)
var h=t.pos
117!=t.input.charCodeAt(++t.pos)&&t.raise(t.pos,"Expecting Unicode escape sequence \\uXXXX"),++t.pos
var p=t.readCodePoint();(r?s:i)(p,a)||t.raise(h,"Invalid Unicode escape"),e+=f(p),n=t.pos}r=!1}return e+this.input.slice(n,this.pos)},ut.readWord=function(){var t=this.readWord1(),e=j.name
return this.keywords.test(t)&&(this.containsEsc&&this.raiseRecoverable(this.start,"Escape sequence in keyword "+t),e=P[t]),this.finishToken(e,t)}
t.version="5.0.3",t.parse=m,t.parseExpressionAt=x,t.tokenizer=y,t.addLooseExports=v,t.Parser=J,t.plugins=W,t.defaultOptions=z,t.Position=q,t.SourceLocation=X,t.getLineInfo=h,t.Node=nt,t.TokenType=N,t.tokTypes=j,t.keywordTypes=P,t.TokContext=ot,t.tokContexts=ht,t.isIdentifierChar=i,t.isIdentifierStart=s,t.Token=ct,t.isNewLine=a,t.lineBreak=I,t.lineBreakG=R,t.nonASCIIwhitespace=O,Object.defineProperty(t,"__esModule",{value:!0})})},function(e,s){e.exports=t},function(t,e,s){"use strict"
